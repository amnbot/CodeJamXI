  ...
  return (
    <div>
        <div className="flex flex-row justify-center gap-[2%] my-[2%]">  
            ...
            <h1 className="flex text-2xl justify-center content-center mt-[3%]">{user.name}'s user profile</h1>
        </div>

        <div className="my-[5%]">
            <h2 className="flex text-2xl justify-center content-center">Scenes you wrote</h2>
            {displayItems(userScenes)}
        </div>

        <div className='my-[5%]'>
        <h2 className="flex text-2xl justify-center content-center">Scenes you liked</h2>
